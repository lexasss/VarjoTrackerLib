    ...
    , m_vsync(vsync)
{
    ...
    createWindow(title, width, height, windowclass);
...
void UI::createWindow(const std::wstring& title, int width, int height, const std::wstring& windowclass)
{
...
void UI::setWindowTitle(const std::wstring& title) { SetWindowTextW(m_hWnd, title.c_str()); }
