...
VARJORUNTIME_DEPRECATED static const varjo_EventType varjo_EventType_HeadsetStandbyStatus =
    0x6;  //!< Event for changes in standby status. @deprecated, varjo_EventType_StandbyStatus should be used.
...
static const varjo_EventType varjo_EventType_VisibilityMeshChange = 0xE;     //!< Event emitted when occlusion/visibility mesh has changed.
...
struct varjo_EventVisibilityMeshChange {
    uint32_t viewIndex;  //!< viewIndex for which visibility/occlusion mesh is changed and should be re-queried.
};
...
union varjo_EventData {
    ...
    VARJORUNTIME_DEPRECATED struct varjo_EventHeadsetStandbyStatus
        headsetStandbyStatus;                         //!< Headset standby status event data. @deprecated, varjo_EventStandbyStatus should be used,
