 ...
 */
static const char* const varjo_IPDParametersKey_AdjustmentMode = "AdjustmentMode";        //!< Interpupillary distance adjustment mode.
static const char* const varjo_IPDParametersValue_AdjustmentModeManual = "Manual";        //!< Interpupillary distance is adjusted manually.
static const char* const varjo_IPDParametersValue_AdjustmentModeAutomatic = "Automatic";  //!< Interpupillary distance is adjusted automatically.
 ...
 * Gaze parameters
 */
static const char* const varjo_GazeParametersKey_OutputFilterType = "OutputFilterType";  //!< Gaze output filter type.
static const char* const varjo_GazeParametersValue_OutputFilterStandard = "Standard";    //!< Standard smoothing output filter.
static const char* const varjo_GazeParametersValue_OutputFilterNone = "None";            //!< Output filter disabled.

static const char* const varjo_GazeParametersKey_OutputFrequency = "OutputFrequency";              //!< Gaze output update frequency.
static const char* const varjo_GazeParametersValue_OutputFrequency100Hz = "OutputFrequency100Hz";  //!< 100Hz output frequency.
static const char* const varjo_GazeParametersValue_OutputFrequency200Hz = "OutputFrequency200Hz";  //!< 200Hz output frequency.
 ...
 */
static const char* const varjo_GazeCalibrationParametersKey_CalibrationType = "GazeCalibrationType";  //!< Gaze calibration type.
static const char* const varjo_GazeCalibrationParametersValue_CalibrationFast = "Fast";               //!< Fast (5-dot) gaze calibration.
static const char* const varjo_GazeCalibrationParametersValue_CalibrationOneDot = "OneDot";           //!< One dot gaze calibration

VARJORUNTIME_DEPRECATED static const char* const varjo_GazeCalibrationParametersValue_CalibrationLegacy =
...
VARJORUNTIME_DEPRECATED static const char* const varjo_GazeCalibrationParametersKey_OutputFilterType = "OutputFilterType";
VARJORUNTIME_DEPRECATED static const char* const varjo_GazeCalibrationParametersValue_OutputFilterStandard = "Standard";
VARJORUNTIME_DEPRECATED static const char* const varjo_GazeCalibrationParametersValue_OutputFilterNone = "None";
