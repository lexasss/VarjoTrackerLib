...
static const varjo_CameraPropertyType varjo_CameraPropertyType_EyeReprojection = 6;      //!< Reproject the image to correspond the physical position of user's eyes.
static const varjo_CameraPropertyType varjo_CameraPropertyType_AutoExposureBehavior = 7; //!< Auto exposure behavior.
static const varjo_CameraPropertyType varjo_CameraPropertyType_FocusDistance = 8;        //!< Set focus distance in cm for AF cameras.

/**
 * Available auto exposure presets for #varjo_CameraPropertyType_AutoExposureBehavior property.
 */
static const int64_t varjo_AutoExposureBehavior_Normal = 0;               //!< Original auto exposure behavior which is suitable for wide
                                                                          //!< range of use cases in general.
static const int64_t varjo_AutoExposureBehavior_PreventOverexposure = 1;  //!< More aggressive behavior to prevent any oversaturation in the image.
