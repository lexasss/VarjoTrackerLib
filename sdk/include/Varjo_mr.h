 ...
 * - Auto exposure behavior: Controls how video pass through reacts to lighting and environment changes when auto
 *                           exposure is in use. Doesn't have any effect if both ExposureTime and ISOValue are in manual mode.
 *                           Possible values are enumerated as follows:
